...
//        mProgressView = findViewById(R.id.login_progress);
    ...
    private void attemptLogin() {
        ...
        if (TextUtils.isEmpty(email)) {
            ...
            cancel = true;
        } else if (!CredentialVerification.getInstance().validateUsername(mUsernameView, email)) {
            cancel = true;
        }
...
//            mAuthTask = new UserLoginTask(email, password);
            ...
            firebaseAuth.signInWithEmailAndPassword(mUsernameView.getText().toString(), mPasswordView.getText().toString())
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        @Override
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            Intent success = new Intent(getBaseContext(), MainActivity.class);
                            Intent failure = new Intent(getBaseContext(), LoginActivity.class);
...
//    }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            // TODO: add a clickable notification to go to the register account screen after several attempts
            return false;
        }
